...
// Replace this line in your dashboard.php
$sql_recent_illness = "SELECT * FROM illness_cases ORDER BY reported_date DESC LIMIT 5";

// With this query that joins the tables
$sql_recent_illness = "SELECT i.*, 
...
<!-- Page content starts here - header.php has already opened the necessary HTML tags -->
...
<!-- Page content ends here - footer.php will close the remaining HTML tags -->
